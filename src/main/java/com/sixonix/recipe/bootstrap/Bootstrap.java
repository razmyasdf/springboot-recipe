package com.sixonix.recipe.bootstrap;

import com.sixonix.recipe.models.*;
import com.sixonix.recipe.repositories.CategoryRepository;
import com.sixonix.recipe.repositories.RecipeRepository;
import com.sixonix.recipe.repositories.UnitOfMeasureRepository;
...
public class Bootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        recipeRepository.saveAll(getRecips());
    }

    public List<Recipe> getRecips(){
